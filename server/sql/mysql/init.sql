...
VALUES
    (1926254740090523648, 0, 'MYSQL', 'MYSQL关系数据库', '#7eb0c8', true, ''),
    (1926272538225287168, 0, '东方Project', '东方Project', '#7ec897', true, ''),
    (1926273266499067904, 0, 'Hololive', '虚拟主播', '#9b7ec8', true, '');
